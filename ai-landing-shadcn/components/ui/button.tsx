...
const variantClasses: Record<ButtonVariant, string> = {
  default: "bg-black text-white hover:bg-neutral-800 dark:bg-white dark:text-black dark:hover:bg-neutral-100",
  secondary: "bg-white text-black border border-neutral-200 hover:bg-neutral-100 dark:bg-neutral-900 dark:text-white dark:border-neutral-800 dark:hover:bg-neutral-800",
  ghost: "bg-transparent text-black hover:bg-neutral-100 dark:text-white dark:hover:bg-neutral-800",
  destructive: "bg-red-600 text-white hover:bg-red-700",
  outline: "bg-transparent text-neutral-900 border border-neutral-200 hover:bg-neutral-100 dark:text-neutral-100 dark:border-neutral-800 dark:hover:bg-neutral-900",
};
